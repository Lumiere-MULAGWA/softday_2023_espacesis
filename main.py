...
def get_prediction():
	...
	return render_template('prediction.html',diabetic=diabetic, name=name,smoking=smoking,physical_activity=physical_activity,alcohol=alcohol,sleep_time=int(sleep_time), heart_risk_rate=f"{model_prediction}%")
